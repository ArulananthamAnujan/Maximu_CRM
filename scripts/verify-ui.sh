...
pg_stage_sql "${work}" "${root}"/supabase/migrations/*.sql \
  "${root}/scripts/rls/00_supabase_shim.sql" "${root}/scripts/audit/seed.sql" "${root}/scripts/rls/task_function_access.sql" "${root}/scripts/rls/staff_permission_groups.sql" "${root}/scripts/rls/task_email_notifications.sql"
...
pg_run "${work}/sql/task_email_notifications.sql"
